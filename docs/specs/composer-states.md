...
**Listening again (Lindsay, 2026-09-08).** After `go on` the field says "Listening again. Your words would show up here. This one only listens." — by the second listen the viewer has noticed no transcript appeared, and the honest answer goes where they are looking. (The missing thing is a transcript; the feature is live transcription, speech-to-text.) The caption carries the same fact as a fourth line, **Not**.
