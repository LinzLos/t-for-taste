...
| leaving | quiet dots · teal | plain | You were talking. Keep going, or close? · You have a request here. Keep it, or close? | stopped — `keep going`/`keep it` · `close` sit where a glyph would |
