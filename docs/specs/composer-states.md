...
| leaving | quiet dots · teal | plain | You were talking. Keep going, keep it, or close? · You have a request here. Keep it, or close? | stopped — `keep going` · `keep it` · `close` at the field's right |
