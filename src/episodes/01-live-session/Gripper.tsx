...
// 119×64 and a 9×3 meter, on purpose: a wider plate for a 27×5 meter stretched the face and lost the
// cute (Lindsay, 2026-09-08). The 27×5 pattern is kept in the spec (§19) for a bigger instrument someday.
...
const FLAT = 'M 14 47 Q 59.5 47 105 47'
const SMILE = 'M 20 42 Q 59.5 63 99 42' // its stroke bottoms out ~3px above the edge
